...
const IngredientsList: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 w-screen height-screen">
      <h1 className="flex flex-row justify-center text-2xl font-bold mb-6 mt-6">Ingredient Scores: "Cetaphil Moisturizer"</h1>
      <div className="pulse-animation w-full height-full mt-20 items-center flex flex-row justify-center"><GaugeGraph2 /></div>
