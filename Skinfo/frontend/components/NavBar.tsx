...
const NavBar = () => {
  const [activeIndex, setActiveIndex] = useState(0); // Manage the active icon state

  return (
    <nav className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-3/4 bg-white shadow-md rounded-lg p-4">
